...
2. **استخدم هذا القالب** — في صفحة GitHub، اضغط على **"Use this template"** ← **"Create a new repository"** لإنشاء مستودعك الخاص. اسم المستخدم واسم المستودع سيحددان رابط موقعك (`https://<اسم-المستخدم>.github.io/<اسم-المستودع>/`)
