...
2. **השתמש בתבנית זו** — בדף GitHub לחץ על **"Use this template"** → **"Create a new repository"** כדי ליצור מאגר משלך. שם המשתמש ושם המאגר ב-GitHub יקבעו את כתובת האתר (`https://<שם-משתמש>.github.io/<שם-repo>/`)
